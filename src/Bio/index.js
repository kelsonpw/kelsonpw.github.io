    ...
    <div className="Bio">
      <div className="Bio__about">
        ...
        <p>
          ...
          One of my favorite things is seeing something go from just an idea, to
          being a fully functioning piece of software.
        </p>
        <p>
          ...
          want to be constantly learning, and pushing my self to build more and
          more awesome things!
        </p>
      </div>
